...
export function LoginPage() {
  ...
  return <div className="login-container"><div className="login-box"><div className="login-header"><h1>HOKEX</h1><p>전국 전시·컨벤션 정보 플랫폼</p></div><div className="login-content">
    <h2>호켁스 시작하기</h2><p className="login-description">소셜 계정으로 빠르게 로그인하세요. 처음 가입하는 경우에만 로그인 후 필수 동의를 진행합니다.</p>
    ...
    <p className="social-notice">소셜 로그인은 기존 회원 로그인과 신규 회원가입을 구분해 처리합니다.</p>
